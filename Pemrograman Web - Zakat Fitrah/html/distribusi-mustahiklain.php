...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Data Distribusi Zakat Fitrah</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="\zakatfitrah/index.php" class="text-muted">Distribusi Zakat Fitrah</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Mustahik Lain</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div id="mustahik_table" class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        include "config.php";
                                        $no = 1;
                                        $query = mysqli_query($conn, 'SELECT * FROM mustahik_lainnya');
                                        while ($data = mysqli_fetch_array($query)) {
                                        ?>
                                        <tbody>
                                            <tr>
                                                <td><span class="badge badge-light-warning"><?php echo $no++ ?></span></td>
                                                <td><a href="javascript:void(0)" class="font-bold link"><?php echo  "". $data['nama'] ?></a></td>
                                                <td><?php echo $data['kategori'] ?></td>
                                                <td><?php echo $data['hak'] ?> Kg</td>
                                                <td>
                                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                        <a <input type="button" name="view" value="Lihat Detail" id_mustahiklainnya="<?php echo $data["id_mustahiklainnya"]; ?>" class="dropdown-item btn btn-info btn-xs view_data"><i data-feather="eye" class="svg-icon"></i> See Details</a>
                                                        <a <input type="button" name="edit" value="Edit" id_mustahiklainnya="<?php echo $data["id_mustahiklainnya"]; ?>" class="dropdown-item btn btn-info btn-xs edit_data"><i data-feather="edit-3" class="svg-icon"></i> Edit</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href="delete_mustahiklain.php?id_mustahiklainnya=<?php echo $data['id_mustahiklainnya']; ?>"><i data-feather="x-circle" class="svg-icon"></i> Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
    ...
    <div id="add_data_Modal" class="modal fade" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            ...
            <h4 class="mt-2"><center>Insert Data Distribusi Zakat (Warga)</center></h4>
                <div class="modal-body">
                    ...
                    <form id="fupForm" class="pl-3 pr-3" action="" method="POST">
                        ...
                        <div class="form-group">
                            <label class="mr-sm-2" for="kategori">Kategori</label>
                        ...
                        <div class="form-group">
                            <label for="hak">Jumlah Hak</label>
                            <input class="form-control" type="text" required=""
                                id="hak" placeholder="Jumlah Hak">
                        </div>
...
<div id="dataModal" class="modal fade">
 <div class="modal-dialog">
  <div class="modal-content">
   ...
   <h4 class="mt-2"><center>Details Warga</center></h4>
   <div class="modal-body" id="detail_mustahiklainnya">
   </div>
...
//Begin Tampil Detail 
 $(document).on('click', '.view_data', function(){
  ...
  var id_mustahiklainnya = $(this).attr("id_mustahiklainnya");
  $('#nama').val(nama);
  $.ajax({
   url:"select_mustahiklain.php",
   method:"POST",
   data:{id_mustahiklainnya:id_mustahiklainnya},
   success:function(data){
    $('#detail_mustahiklainnya').html(data);
...
<div id="editModal" class="modal fade">
 <div class="modal-dialog">
  ...
  <div class="modal-header">
    ...
    <h4 class="mt-2"><center>Ediit Data Distribusi Zakat (Mustahik Lainnya)</center></h4>
