            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1"> Welcome, <code><?php echo $_SESSION['email']; ?></code> !</h3>
                    ...
                    <div class="col-12 mt-4">
                        ...
                        <div class="card">
                            ...
                            <center><h4 class="card-title">CryptMAIL</h4>
                                ...
                                <a href="compose.php" class="btn btn-primary">Compose mail</a>
                            </div>
                        </div>
                        <!-- Card -->
                    </div>
