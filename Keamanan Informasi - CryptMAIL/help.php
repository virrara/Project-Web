            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Help</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Others</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Help</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 mt-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                           <center><h4 class="card-title">Bantuan Untuk Pengguna Aplikasi</h4></center>
                           <br><br>
                                <p class="card-subtitle"> 1. Dashboard : Menu halaman utama ketika telah melakukan login.
                                </p> 
                                <p class="card-subtitle"> 2. Create Message : Menu untuk membuat pesan 
                                    dan mengirimkannya ke alamat email tujuan. 
                                </p>
                                <p class="card-subtitle"> 3. Inbox : Menu untuk melihat pesan yang masuk. 
                                    Untuk membaca pesan pengguna diharuskan memasukkan kunci kriptografi 
                                    untuk mendekrip pesan yang diterima.
                                </p>
                                <p class="card-subtitle"> 4. Help : Menu untuk membantu user dalam penggunaan aplikasi
                                    dan keterangan tentang fitur yang tersedia.
                                </p>
                                <p class="card-subtitle"> 5. About App : Menu informasi tentang aplikasi kriptografi email.
                                </p>
                                <p class="card-subtitle"> 6. About Us : Menu informasi tentang kelompok kami.
                                </p>
                            </div>
                        </div>
                        <!-- Card -->
