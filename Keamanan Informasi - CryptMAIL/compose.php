            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Compose Mail</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="index.html" class="text-muted">Apps</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Compose Mail</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <form method="post" class="form-horizontal" action="sendmail.php" enctype="multipart/form-data">
                                  <div class="form-group row">
                                      ...
                                      <div class="col-md-10">
                                        <input type="email" class="form-control" name="tujuan" autocomplete="off" required placeholder="Recipients">
                                      </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-md-2">Subject</label>
                                        <div class="col-md-10">
                                          <input type="text" class="form-control form-control-line" name="judulpesan" autocomplete="off" required placeholder=Subject>
                                        </div>
                                      </div>
                                    <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-10">
                                          <input type="submit" class="btn btn-success" name="kirimemail" value="Send Mail">
