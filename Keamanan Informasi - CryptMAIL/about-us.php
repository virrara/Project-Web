                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card text-center">
                            <div class="card-body">
                                ...
                                <img src="assets/images/users/vir.png" alt="image" class="rounded-circle"
                                width="100">
                                <p class="card-text"><br>Name : Virra Retnowati A'izzah <br>
                                    NPM : 207006020 <br>
                                    Class : A <br>
                                    Grade : Fourth Semester
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="card text-center">
                            <div class="card-body">
                                <h4 class="card-title">Profile</h4>
                                <img src="assets/images/users/dwi1.jpg" alt="image" class="rounded-circle"
                                width="100">
                                <p class="card-text"><br>Name : Dwi Ramti Asih <br>
                                    NPM : 207006029 <br>
                                    Class : A <br>
                                    Grade : Fourth Semester
                                </p>
                    ...
                    <div class="col-md-4">
                        <div class="card text-center">
                            <div class="card-body">
                                <h4 class="card-title">Profile</h4>
                                <img src="assets/images/users/anggi1.jpeg" alt="image" class="rounded-circle"
                                width="100">
                                <p class="card-text"><br>Name : Anggi Putri Meriani <br>
                                    NPM : 207006068 <br>
                                    Class : C <br>
                                    Grade : Fourth Semester
                                </p>
                    ...
                    <div class="col-md-15">
                        <div class="card text-white bg-dark">
                            <div class="card-header">
                                <h4 class="mb-0 text-white text-center">About us</h4>
                            </div>
                            <div class="card-body">
                                <h3 class="card-title text-white">Hi!</h3>
                                <p class="card-text">We're 4th semester students of the Informatics Department, Siliwangi University. 
                                    This assignment is for a major assignment for the course 'Information Security'
                                </p>
                        </div>
                    </div>
                </div>
