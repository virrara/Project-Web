            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">About Application</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 mt-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                            <center><h4 class="card-title">CryptMAIL</h4>
                                <img src="assets/images/CryptMAIL.png" alt="image"
                                class="img-fluid img-rounded" width="300">
                                <p class="card-title">Email cryptography security app.
                                </p>
                                <p class="card-subtitle">Send email more securely with cryptography.
                                </p>
                                <p class="card-subtitle">Aplikasi ini dibuat untuk memenuhi tugas besar mata kuliah "Keamanan Informasi"<br>
                                     Aplikasi ini menggunakan algoritma AES dan RC4 untuk menjaga kerahasiaan pesan email user.
                                </p>
                            </div>
                        </div>
                        <!-- Card -->
