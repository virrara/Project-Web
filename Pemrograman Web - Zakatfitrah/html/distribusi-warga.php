                            ...
                            <div class="card-body">
                                <div id="mustahik_table" class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        include "config.php";
                                        $no = 1;
                                        $query = mysqli_query($conn, 'SELECT * FROM mustahik_warga');
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                        <a <input type="button" name="view" value="Lihat Detail" id_mustahikwarga="<?php echo $data["id_mustahikwarga"]; ?>" class="dropdown-item btn btn-info btn-xs view_data"><i data-feather="eye" class="svg-icon"></i> See Details</a>
                                                        <a <input type="button" name="edit" value="Edit" id_mustahikwarga="<?php echo $data["id_mustahikwarga"]; ?>" class="dropdown-item btn btn-info btn-xs edit_data"><i data-feather="edit-3" class="svg-icon"></i> Edit</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href="delete_warga.php?id_mustahikwarga=<?php echo $data['id_mustahikwarga']; ?>"><i data-feather="x-circle" class="svg-icon"></i> Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
...
<div id="dataModal" class="modal fade">
 <div class="modal-dialog">
  <div class="modal-content">
   ...
   <div class="modal-body" id="detail_warga">
   </div>
...
//Begin Tampil Detail 
 $(document).on('click', '.view_data', function(){
  ...
  var id_mustahikwarga = $(this).attr("id_mustahikwarga");
  $('#nama').val(nama);
  $.ajax({
   url:"select_warga.php",
   method:"POST",
   data:{id_mustahikwarga:id_mustahikwarga},
   success:function(data){
    $('#detail_warga').html(data);
...
<div id="editModal" class="modal fade">
 <div class="modal-dialog">
  ...
  <div class="modal-header">
    ...
    <h4 class="mt-2"><center>Ediit Data Distribusi Zakat (Warga)</center></h4>
