            ...
            <div class="page-breadcrumb">
                <div class="row">
                    ...
                    <div class="col-5 align-self-center">
                        <div>
                            <a href="pdf-lap-lain.php" class="btn btn-rounded btn-outline-primary" target="_blank">
                            Export to PDF
                            </a>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                <div id="mustahik_table" class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td><span class="font-bold link ">Amilin</span></td>
                                                <td><a href="javascript:void(0)" class="font-bold link">10 Kg</a></td>
                                                <td><?php echo $jml_amil; ?></td>
                                                <td><?php echo 10*$jml_amil; ?> Kg</td>
                                            </tr>
                                            <tr>
                                                <td><span class="font-bold link">Fisabilillah</span></td>
                                                <td><a href="javascript:void(0)" class="font-bold link">3 Kg</a></td>
                                                <td><?php echo $jml_fisabilillah; ?></td>
                                                <td><?php echo 3*$jml_fisabilillah; ?> Kg</td>
                                            </tr>
                                            <tr>
                                                <td><span class="font-bold link">Mualaf</span></td>
                                                <td><a href="javascript:void(0)" class="font-bold link">4 Kg</a></td>
                                                <td><?php echo $jml_mualaf; ?></td>
                                                <td><?php echo 4*$jml_mualaf; ?> Kg</td>
                                            </tr>
                                            <tr>
                                                <td><span class="font-bold link">Ibnu Sabil</span></td>
                                                <td><a href="javascript:void(0)" class="font-bold link">4 Kg</a></td>
                                                <td><?php echo $jml_ibnsabil; ?></td>
                                                <td><?php echo 4*$jml_ibnsabil; ?> Kg</td>
                                            </tr>
                                        </tbody>
                                    </table>
