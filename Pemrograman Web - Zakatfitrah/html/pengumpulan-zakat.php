...
<body>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Data Pengumpulan Zakat Fitrah</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Pengumpulan Zakat Fitrah</li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Data Pengumpulan</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div id="bayar_table" class="table-responsive">
                                    <table id="zero_config" class="table table-striped table-bordered no-wrap">
                                        ...
                                        include "config.php";
                                        $no = 1;
                                        $query = mysqli_query($conn, 'SELECT * FROM bayarzakat');
                                        while ($data = mysqli_fetch_array($query)) {
                                        ?>
                                        <tbody>
                                            <tr>
                                                <td><span class="badge badge-light-warning"><?php echo $no++ ?></span></td>
                                                <td><a href="javascript:void(0)" class="font-weight-medium link"><?php echo $data['nama_KK'] ?></a></td>
                                                <td><a href="javascript:void(0)" class="font-bold link"><?php echo $data['jumlah_tanggungan'] ?></a></td>
                                                <td><a href="javascript:void(0)" class="font-bold link"><?php echo $data['jenis_bayar'] ?></a></td>
                                                <td><a href="javascript:void(0)" class="font-bold link"><?php echo $data['jumlah_tanggunganyangdibayar'] ?></a></td>
                                                <td><?php echo $data['bayar_beras'] ?></td>
                                                <td><?php echo number_format($data['bayar_uang'],0,",",".") ?></td>
                                                <td>
                                                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button"
                                                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                                        <a <input type="button" name="view" value="Lihat Detail" id_zakat="<?php echo $data["id_zakat"]; ?>" class="dropdown-item btn btn-info btn-xs view_data"><i data-feather="eye" class="svg-icon"></i> See Details</a>
                                                        <a <input type="button" name="edit" value="Edit" id_zakat="<?php echo $data["id_zakat"]; ?>" class="dropdown-item btn btn-info btn-xs edit_data"><i data-feather="edit-3" class="svg-icon"></i> Edit</a>
                                                        <div class="dropdown-divider"></div>
                                                        <a class="dropdown-item" href="delete_bayar.php?id_zakat=<?php echo $data['id_zakat']; ?>"><i data-feather="x-circle" class="svg-icon"></i> Delete</a>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
    ...
    <div id="add_data_Modal" class="modal fade" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog">
            ...
            <h4 class="mt-2"><center>Insert Data Pembayaran Zakat</center></h4>
                <div class="modal-body">
                    ...
                    <form id="fupForm" class="pl-3 pr-3" action="" method="POST">
                        ...
                        <div class="form-group">
                            <label for="nama_KK">Nama Muzakki/KK</label>
                            <input class="form-control" type="text" id="nama_KK"
                                required="" placeholder="Nama Muzakki/KK">
                        </div>
                        ...
                        <div class="form-group">
                            <label class="mr-sm-2" for="jenis_bayar">Jenis Bayar</label>
                                <select class="custom-select mr-sm-2" id="jenis_bayar">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" required=""
                                id="jumlah_tanggunganyangdibayar" placeholder="Jumlah Tanggungan Yang Dibayar">
                        </div>

                        <div class="form-group">
                            <label for="bayar_beras">Beras</label>
                            <input class="form-control" type="text" required=""
                                id="bayar_beras" placeholder="Beras">
                        </div>

                        <div class="form-group">
                            <label for="bayar_uang">Uang</label>
                            <input class="form-control" type="text" required=""
                                id="bayar_uang" placeholder="Uang">
                        </div>
...
var jumlah_tanggunganyangdibayar = $('#jumlah_tanggunganyangdibayar').val();
var bayar_beras = $('#bayar_beras').val();
var bayar_uang = $('#bayar_uang').val();
if(nama_KK!="" && jumlah_tanggungan!="" && jenis_bayar!="" && jumlah_tanggunganyangdibayar!="" && bayar_beras!=""
&& bayar_uang!=""){
    $.ajax({
		url: "insert_bayar_manual.php",
		type: "POST",
		data: {
			nama_KK: nama_KK,
...
<div id="dataModal" class="modal fade">
 <div class="modal-dialog">
  <div class="modal-content">
   ...
   <h4 class="mt-2"><center>Details Pembayaran Zakat</center></h4>
   <div class="modal-body" id="detail_bayar">
   </div>
...
<div id="editModal" class="modal fade">
 <div class="modal-dialog">
  ...
  <div class="modal-header">
    ...
    <h4 class="mt-2"><center>Edit Data Pembayaran Zakat</center></h4>
