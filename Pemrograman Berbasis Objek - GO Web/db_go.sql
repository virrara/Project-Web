...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 28, 2021 at 12:03 PM
...
--
-- Table structure for table `tb_proof`
--

CREATE TABLE `tb_proof` (
  `pr_batch` int(100) NOT NULL,
  `pr_image` text NOT NULL,
  `pr_resi` text NOT NULL,
  `pr_tanggal` text NOT NULL,
  `pr_barang` text NOT NULL,
  `pr_status` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tb_proof`
--

INSERT INTO `tb_proof` (`pr_batch`, `pr_image`, `pr_resi`, `pr_tanggal`, `pr_barang`, `pr_status`) VALUES
(1, 'Blue Floral Collage Wallpaper (1).png', 'SJ1312312', '2021-11-18', 'SJ Sharing kit', 'Arrived WH KR');
...
--
-- Indexes for table `tb_proof`
--
ALTER TABLE `tb_proof`
  ADD PRIMARY KEY (`pr_batch`);
...
--
-- AUTO_INCREMENT for table `tb_proof`
--
ALTER TABLE `tb_proof`
  MODIFY `pr_batch` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
