...
$db = mysqli_connect("localhost", "root", "", "db_go");
  ...
  if (isset($_POST['upload'])) {
  	...
  	$sql = "INSERT INTO tb_testi (image, text) VALUES ('$image', '$text')";
  	// execute query
  	mysqli_query($db, $sql);
        ...
        <main class="main">
           ...
           <<section class="product section container" id="note">
                <h2 class="section__title-center">
                    Give Us Your <br> Testimoni Here !
                </h2>

                <p class="product__description">
                    Masukkan penilaian terhadap kami jangan lupa tampilkan gambarnya :)
                </p>
                ...
                <title>Image Upload</title>
                    ...
                    ?>
                    <form method="POST" action="adm_testi.php" enctype="multipart/form-data">
