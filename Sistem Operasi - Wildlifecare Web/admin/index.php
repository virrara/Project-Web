            ...
            <div class="scroll-sidebar" data-sidebarbg="skin6">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="html/news.php"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link" href="html/donation.php"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link has-arrow" href="javascript:void(0)"
                            ...
                            <ul aria-expanded="false" class="collapse  first-level base-level-line">
                                <li class="sidebar-item"><a href="html/volunteer-data.php" class="sidebar-link"><span
                                            class="hide-menu"> Data Volunteer
                                        </span></a>
                                </li>
                                <li class="sidebar-item"><a href="html/simple-recruitment-dss-ahp/index.php" class="sidebar-link"><span
                                            class="hide-menu"> Filtering volunteer
                                        </span></a>
                                </li>
                            </ul>
                        </li>
                        <li class="sidebar-item"> <a class="sidebar-link" href="html/community.php"
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="html/about-app.php"
                                aria-expanded="false"><i data-feather="github" class="feather-icon"></i><span
                                    class="hide-menu">About App</span></a></li>
                        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="html/about-me.php"
            ...
            <div class="container-fluid">
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">New Volunteer Registrar</h6>
                                </div>
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">New Donations
                                    </h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                        ...
                        <div class="card-body">
                            <div class="d-flex d-lg-flex d-md-block align-items-center">
                                <div>
                                    ...
                                    <h6 class="text-muted font-weight-normal mb-0 w-100 text-truncate">New Member of Community</h6>
                                </div>
                                <div class="ml-auto mt-md-3 mt-lg-0">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <ul class="list-style-none mb-0">
                                    ...
                                    <li class="mt-3">
                                        ...
                                        <span class="text-muted">Lolos tahap interview</span>
                                        <span class="text-dark float-right font-weight-medium">1108</span>
                                    </li>
                                    <li class="mt-3">
                                        <i class="fas fa-circle text-cyan font-10 mr-2"></i>
                                        <span class="text-muted">Lolos semua tahap</span>
                                        <span class="text-dark float-right font-weight-medium">204</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Donations Income</h4>
                                <div class="net-income mt-4 position-relative" style="height:294px;"></div>
                                <ul class="list-inline text-center mt-5 mb-2">
                                    <li class="list-inline-item text-muted font-italic">Donations for this months</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3 align-items-center mt-1 mt-5">
                                    <div class="col-4 text-right">
                                        <span class="text-muted font-14">Jawa Barat</span>
                                    </div>
                                    <div class="col-5">
                                    ...
                                    <div class="col-3 text-right">
                                        <span class="mb-0 font-14 text-dark font-weight-medium">Jakarta</span>
                                    </div>
                                </div>
                                <div class="row mb-3 align-items-center">
                                    <div class="col-4 text-right">
                                        <span class="text-muted font-14">Jawa Timur</span>
                                    </div>
                                    <div class="col-5">
                                        <div class="progress" style="height: 5px;">
                                ...
                                <div class="row mb-3 align-items-center">
                                    <div class="col-4 text-right">
                                        <span class="text-muted font-14">Kalimantan</span>
                                    </div>
                                    <div class="col-5">
                                        <div class="progress" style="height: 5px;">
                                ...
                                <div class="row align-items-center">
                                    <div class="col-4 text-right">
                                        <span class="text-muted font-14">Sulawesi</span>
                                    </div>
                                    <div class="col-5">
                                        <div class="progress" style="height: 5px;">
