<!DOCTYPE html>
    ...
    <head>
        ...
        <title>Wildlife Care - Thanks for Donating!</title>
    </head>
    <body>
        <!--==================== HEADER ====================-->
            ...
            <section class="home" id="home">
                <div class="home__container container grid">
                    ...
                    <div class="home__data">
                        ...
                        Tunggu email kami untuk konfirmasi dan thank you card or sertifikat donasi sebagai apresiasi kami.
                        <br>
                        Kamu juga akan mulai mendapatkan e-newsletter dan email bulanan kami yang akan menginformasikan
                         update dari project kami dan bagaimana kamu bisa berjasa untuk menolong 
            ...
            <section class="questions section" id="products">
                ...
                <div class="product__container grid">
                    ...
                    <article class="product__card">
                        ...
                        <a href="share.php"><img src="assets/img/5.png" alt="" class="product__img"></a>
                        <a href="share.php">
                        <center><h3 class="product__title">Interact & Share</h3>
                        </a>
                        
                        <span class="product__price">Show off your love of wildlife and nature with these 
                                    fun activitie.</span></center>
                        <br>
                        <a href="share.php" class="button--flex product__button">
                           <i class="ri-arrow-right-down-line button__icon"></i>
                        </a>
                    </article>
                </div>
